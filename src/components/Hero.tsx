...
export default function Hero({ onOpenReservation }: HeroProps) {
  ...
  return (
    <section
      className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-primary pt-24 pb-16 lg:pt-28 lg:pb-20"
      id="hero"
    >
      {/* Premium Full-Screen Background Image */}
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        <img
          src="/src/assets/images/luxury_coffee_pastry_bg_1782323367843.jpg"
          alt="Luxury Coffee and Pastry Background"
          className="w-full h-full object-cover filter brightness-[0.25] contrast-[1.1]"
          referrerPolicy="no-referrer"
        />
        {/* Deep, luxurious gradient overlays to merge with neighboring sections and secure text readability */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#1E110B]/95 via-[#3B241A]/75 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#100F05]/70 via-transparent to-[#F8F5F0]" />
        <div className="absolute inset-0 bg-[radial-gradient(#C89B3C_0.8px,transparent_0.8px)] [background-size:24px_24px] opacity-15" />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-5/12 flex flex-col justify-center relative z-10 text-left">
            ...
            >
              ...
              <span className="text-xs text-cream/60 font-mono">• Addis Ababa</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-normal leading-[1.05] mb-6 text-cream tracking-tight"
              id="hero-heading"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-cream/80 font-light mb-8 max-w-xl leading-relaxed pr-2 lg:pr-8"
              id="hero-desc"
            >
            ...
            >
              <button
                ...
                className="px-8 py-3.5 bg-accent hover:bg-accent-hover text-primary text-[11px] uppercase tracking-[0.2em] font-bold transition-all duration-300 shadow-luxury flex items-center gap-2 group cursor-pointer"
                id="hero-reserve-btn"
              >
                <CalendarRange className="h-4 w-4 text-primary transition-transform group-hover:scale-110" />
                Reserve a Table
              </button>

              <a
                href="#/menu"
                className="px-8 py-3.5 border border-cream/30 text-[11px] uppercase tracking-[0.2em] font-bold text-cream hover:border-accent hover:text-accent transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer bg-transparent"
                id="hero-menu-btn"
              >
                Explore Menu
              </a>
            ...
            <motion.div
              ...
              className="mt-12 lg:mt-16 flex items-center gap-8 border-t border-cream/10 pt-6"
              id="hero-hours"
            >
              <div className="flex flex-col">
                <span className="text-sm font-bold text-cream font-serif">07:00 — 21:00</span>
                <span className="text-[9px] uppercase tracking-widest text-cream/60">Weekdays</span>
              </div>
              <div className="w-[1px] h-8 bg-cream/20"></div>
              <div className="flex flex-col">
                <span className="text-sm font-bold text-cream font-serif">08:00 — 22:00</span>
                <span className="text-[9px] uppercase tracking-widest text-cream/60">Weekends</span>
              </div>
              <div className="w-[1px] h-8 bg-cream/20"></div>
                  ...
                  <div className="absolute -top-10 flex gap-0.5 h-10 justify-center w-6">
                    {steamParticles.map((_, i) => (
                      <motion.div
                        ...
                        className="w-[1px] bg-accent/40 blur-[0.5px] rounded-full"
                      />
                    ))}
                  </div>
                  <Coffee className="h-4 w-4" />
                </div>
                <span className="text-[9px] font-mono tracking-wider uppercase text-cream/60">Aroma Active</span>
              </div>
            </motion.div>
          ...
          <div className="w-full lg:w-7/12 relative flex items-center justify-center min-h-[360px] sm:min-h-[500px]">
            ...
            <div className="absolute -left-6 lg:-left-12 top-1/2 -translate-y-1/2 select-none pointer-events-none hidden sm:block">
              <span className="vertical-text uppercase tracking-[0.5em] text-[10px] font-bold text-cream/10 whitespace-nowrap block">
